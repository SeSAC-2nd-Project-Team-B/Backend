...
exports.createOrGetRoom = async ({ productId, buyerId, sellerId }) => {
    ...
    if (productId !== undefined && buyerId !== undefined && sellerId !== undefined) {
        console.log("🚀 ~ exports.1createOrGetRoom= ~ productId, buyerId, sellerId:", productId, buyerId, sellerId)
            ...
            console.log("🚀 ~ exports.2createOrGetRoom= ~ productId, buyerId, sellerId:", productId, buyerId, sellerId)
            // 이미 방이 있는지 확인
...
exports.createMessage = async ({ roomId, senderId, messageText }) => {
    if (roomId !== undefined && senderId !== undefined && messageText !== undefined) {
